...
Usage
-----
    python engine_sharpener.py                 # full check, print report
    python engine_sharpener.py --json out.json # machine-readable
    python engine_sharpener.py --quiet         # only show items needing action
    python engine_sharpener.py --section pypi  # check one section only
    python engine_sharpener.py --repo ~/code/story-pipeline
    python engine_sharpener.py --repo ~/engine --repo ~/harness   # multiple
