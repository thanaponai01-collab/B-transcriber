/* Helper transport, kept separate from the panel so the retry rule can be tested.
...
const UNREACHABLE = "Cannot reach CutDeck. Run Start CutDeck.cmd, then try again.";
...
module.exports = { createRpc, URL, ATTEMPTS, UNREACHABLE };
