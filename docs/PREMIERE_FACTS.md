...
| `ClipProjectItem.createSetInOutPointsAction` + overwrite | CATCH | Places exactly the marked span, but only as **two transactions**: set the marks, commit, then overwrite. Restore the marks after. | Ledger 09-24 P2 |
